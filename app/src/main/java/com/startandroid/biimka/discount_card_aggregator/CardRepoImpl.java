...
public class CardRepoImpl implements CardRepo {
        ...
        if (cardsCursor.moveToFirst()) {
            ...
            do {
                cards.add(new Card(cardsCursor.getInt(idColIndex),
                        ...
                        cardsCursor.getLong(contentBarcodeColIndex)));
    ...
    public Card getCard(long id) {
        ...
        if (cardsCursor.moveToFirst()) {
            return new Card(cardsCursor.getInt(cardsCursor.getColumnIndex("id")),
                    ...
                    cardsCursor.getLong(cardsCursor.getColumnIndex("cardId")));
        }
        cardsCursor.close();
        return null;
    }
    ...
    public void createCard(Card card) {
        ...
        contentValuesCard.put("barcodeId", card.getId());
        ...
        contentValuesBarcode.put("cardId", card.getId());
